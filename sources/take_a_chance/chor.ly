...
women_lyr = \lyricmode {
  ...
  When the pret -- ty birds have flown, 
  Ho -- ney I'm still free, 
  Take a chance on me! 
  Ve --  ry best, To the test, 

  (ah)  __ (yeah)  __
  'Long as we're  to -- get --  her.
  (ah)  __ (yeah)  __
...
men_lyr = \lyricmode {
  ...
  \skip 1 \skip 1 \skip 1 \skip 1 \repeat unfold 12 { \skip 1 }

part-Ponezero-one = \drummode {
  ...
  <<
    \context DrumVoice = "voiceone" {
      ...
      hh8 |
      R1 |
      hh4:16 hh16-. hh16 hh16 hh16-> hh16-> hh16 hh8 hh16 hh16
      hh8 |
      % 35
      hh4:16 hh16 hh16 hh16 hh16-> hh16-> hh16 hh16 hh16 hh16
      hh16 hh8 |
    ...
    \context DrumVoice = "voicetwo" {
      \voiceTwo
      bd4 <bd sn >4 |
      bd4 <bd sn >4 bd4 <bd sn >8 r8 |
      % 20
      bd4 sn8. bd16 bd4 sn4 |
      bd4 sn8. bd16 bd4 sn4 |
      bd4 sn8. bd16 bd4 sn4 |
      bd4 <bd sn >4 bd8 sn8 r8 r8 |
      bd4 <bd sn >8. bd16 bd4 <bd sn >4 |
      % 25
      bd4 <bd sn >8. bd16 bd4 <bd sn >4 |
      bd4 <bd sn >8. bd16 bd4 <bd sn >4 |
      bd4 <bd sn >4 bd16 sn8. <bd sn >8 tommh8 |
      bd4 <bd sn >8. bd16 bd4 <bd sn >4 |
      bd4 <bd sn >8. bd16 bd4 <bd sn >4 |
      % 30
      bd4 <bd sn >8. bd16 bd4 <bd sn >4 |
      bd4 <bd sn >4 bd16 sn8. <bd sn >8 tommh8 |
      bd4 bd8. bd16 bd4 <bd sn >4 |
      bd4 <bd sn >4 bd4 <bd sn >4 |
      bd4 <bd sn >8. bd16 bd4 <bd sn >4 |
      % 35
      bd4 bd8. bd16 bd4 <bd sn >4 |

...
sophie_lyr = \lyricmode {
  ...
  My re -- sist -- ance run -- ning low,  
  And ev' -- ry -- day the hold is get -- ting tigh -- ter,  
  And it tro -- bles me so. 

  I'm no -- bo -- dy's fool, and yet it's clear to me,
  I don't have a stra -- te -- gy,
  It's just like tak -- king can -- dy from a ba -- by,  
  And I think I must be

  Un -- der at -- tack 
  I'm be -- ing ta --  ken,  
  A -- bout to crack, 
  De -- fen -- ces break --  ing. 
  Won't some -- bo -- dy please have a heart, 
  Come and res -- cue me now 'cause I'm fal --  ling a -- part.
  
  Un -- der at -- tack, I'm ta -- king co --  ver.
  They're on my track, three dads, one lo --  ver.   
  Think -- ing no -- thing can stop them, 
  Now should I want to, 
  I'm not sure I would know how.     
          
  This is get -- ting cra -- zy, 
  I should tell 'em so, 
  Real -- ly let my an --  guish show,  
  I feel like I was trapped with -- in a night -- mare, 

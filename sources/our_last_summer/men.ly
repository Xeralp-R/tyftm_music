...
PartPFiveVoiceOne =  \relative a' {
    ...
    g2. r4 \bar "||"
    r8 _\mf b8 b8 b8 b8 b8 b8 b16 b16 ~ | \barNumberCheck #10
    ...
    a8 g16 ( a16 ) | % 27
    a1 ~ | % 28
    a4 r4 a8 b8 c8 a16 b16 ~ \bar "||"
    b4 _\f r4 fis8 ( d8 ) d4 | \barNumberCheck #30
    ...
    g4 _\f r4 a8 b8 c8 a16 b16 ~ \bar "||"
    b4 r4 fis8 ( d8 ) d4 | % 38
    ...
    g2. _\> r4 _\! \bar "||"
    R1*4 | % 49
    r8 a8 a8 a8 a4 r4 | \barNumberCheck #50
    R1*14 | % 66
    r4 r4 a8 _\mp b8 c8. a16 | % 65
...
PartPFiveVoiceOneLyricsOne =  \lyricmode { I
    ...
    "seems," 
     Walks a -- long the "Seine," Lau -- ghing in the
    "rain," Our last sum -- "mer,"  Mem -- "'ries"
    that re -- "main."
    }
...
PartPSixVoiceOne =  \relative a' {
    ...
    R1*8 \bar "||"
    R1*4 | % 13
    r8 a8 a8 a8 a8 a8 a8 a8 | % 14
    a4 r4 r2 | % 15
    r8 a8 a8 a8 a8 a8 a8 a8 | % 16
    b8 r8 r4 c2 | % 17
    b4 r4 r2 | % 18
    R1*3 \bar "||"
    r8 _\f a8 a8 a8 a4 r4 | % 22
    r8 a8 a16 a16 b8 ~ b8 a8 a8 g8 | % 23
    R1*2 | % 25
    r8 a8 \once \omit TupletBracket
    \times 2/3  {
        a8 a8 a8 ~ }
    a4 r4 | % 26
    r8 a8 a16 a16 b8 ( ~ \once \omit TupletBracket
...
PartPSevenVoiceOne =  \relative c'' {
    ...
    r2 c2 | % 17
    b4 r4 r2 | % 18
    r8 b8 b8 g16 g16 ~ g8 d8 g8 b8 | % 19

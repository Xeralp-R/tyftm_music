part-Poneone-one = {
  ...
  \time 4/4
  \clef treble
  <d' a' >8\mf <d' b' >8 <d' c'' >8 <d' a' >8 |
  % 0
  <d' g' b' >4 <d' b' >4 <d' fis' b' >4 <d' b' >4 |
  <e' g' c'' >4 <e' c'' >4 <fis' a' d'' >4 <fis' d'' >4 |
  <d' g' b' >4 <d' b' >4 <d' fis' b' >4 <d' b' >4 |
  <e' g' c'' >4 <e' c'' >4 <fis' a' d'' >4 <fis' d'' >4 |
  ...
  <<
    \context Voice = "voiceone" {
      \voiceOne
      <a c' e' g' >4-. <a c' e' g' >4-. a'16 b'16 c''8 c''8 a'8 |
      fis'32 g'32 fis'32 e'32 fis'8~ <fis' a' >4 <a e' a' >4 a'4 |
      <a d' e' a' >4-. <a d' e' a' >4-. e'16 fis'16 g'8 g'8 des'8 |
    }
    \context Voice = "voicetwo" {
      \voiceTwo
      <c' e' g' >4-. <c' e' g' >4-. |
      <a d' a' >4 |
      <a des' e' a' >4-. <a des' e' a' >4-. |
    }
  >>
  ...
  >> |
  % 20
  <c' e' g' >4-^ <c' g' >4 <c' fis' >4-^ <c' fis' >4-^ |
  <c' f' >4-^ <c' f' >4-^ <c' e' >4-^ <c' e' >4-^ |
  <c' g' >4-^ <c' g' >4 <c' fis' >4-^ <c' fis' >4-^ |
  <c' f' >4-^ <c' f' >4-^ <c' e' >4-^ <c' e' >4-^ |
  <c' g' >4-^ <c' g' >4 <c' fis' >4-^ <c' fis' >4-^ |
  % 25
  <c' f' >4-^ <c' f' >4-^ <c' e' >4-^ <c' e' >4-^ |
  ...
  a' >8 |
  <d' g' b' >4\mf <d' g' b' >4 <d' fis' b' >4 <d' fis' b' >4 |
  ...
  <g c' e' g' >4 <g g' >4 <a d' fis' a' >4 <a a' >4 |
  <c' d' g' >4\> <c' d' g' >4 <c' d' g' >4 <c' d' g' >4 |
  g8\mf b8 <d' g' >8 d'8 fis8 b8 <d' fis' >8 d'8 |
  % 45

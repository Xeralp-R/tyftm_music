...
#(set! paper-alist 
(cons '("new_size" . (cons (* 210.061 mm) (* 296.93 mm))) paper-alist))
\paper {
    #(set-paper-size "new_size")
    top-margin = 7.64\mm
    bottom-margin = 5.46001\mm
    left-margin = 6.55001\mm
    right-margin = 9.55\mm
    ragged-last-bottom = ##f
}

\header {
    subtitle = "(as performed by Amanda Seyfried)"
    rights = "©"
...
% 70
    ...
    \time 4/4
    b'8-\markup { \italic "á tempo" } b'8 b'8 bes'16 a'16~ a'8 gis'8 r8 cis'8 |
    e'4 dis'4 fis'8 e'8~ e'4 |
    r8 dis'4 cis'8 dis'4. e'8 |
    gis'4 fis'8( e'8) e'8 dis'8~ dis'4 |
% 75
...
part-Ptwo-one = {
    ...
    << { dis''4~ \tuplet 3/2 { dis''8 cis''8 dis''8 } b'2~-\markup { \italic 
    "rit." } } \\ { g'2 e'4 cis'8( d'8) } >> |
    << { \time 2/4
    b'4 b'4 } \\ { dis'2 } \\ { } >> |
    << { \time 4/4
    <gis' b' >2 <e' g' des'' >2 } \\ { } >> |
...
% 20
    ...
    a'' >8) gis''4 cis''8 |
    << { e''4 dis''4 fis''8 e''8 fis''8 gis''8 } \\ { <fis' bis' >2 <gis' b' 
    >2 } >> |
% 25
    \slashedGrace { cis''8 } gis''8 fis''8 gis''8 cis''8~ cis''2 |
    << { gis''8 fis''8 gis''8 c''8~ c''2 } \\ { <a' c'' >4.\arpeggio\arpeggio 
    } >> |

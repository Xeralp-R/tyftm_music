...
PartPEightVoiceOne =  {
  ...
  d'4 d'4 d'4 d'4 | % 37
  b2. r4 | % 38
  f'8 e'8 f'8 r8 f'8 e'8 e'4 | % 39
  e'2 r8 g8 c'8 e'8 | \barNumberCheck #40
  e'4 e'4 d'4 d'4 | % 41
  ...
  c'4 c'4 c'4 c'4 | % 69
  d'2. r4 | % 70
  d'4 d'4 d'4 d'4 | \barNumberCheck #71
  b2. r8 f'8 | % 72
  f'8 e'8 f'8 r8 f'8 ( e'8 ) e'4 | % 73
  g'4 g'4 f'4 f'4 | % 74
  e'8 d'8 e'8 f'8 e'8 ( d'8 ) d'4 \bar "|."
}


PartPEightVoiceOneLyricsOne =  \lyricmode {
  \set ignoreMelismata = ##t
  Su -- per -- Trou -- per lights are gon -- na find\skip1 me But I\skip1
  "won't" feel\skip1 blue Like I al -- ways do "'Cause" some -- where
  in the crowd\skip1 "there's" you Wish -- ing "ev'" -- ry show was the last -- \skip1 show Glad to
  ...
  crowd "there's" you Ooh\skip1 Ooh ooh ooh ooh ooh ooh Ooh --

part-Psix-one = {
  ...
  f'4 r4 r4 a16\mp c'16 f'16 a'16 |
...
donna_lyr = \lyricmode {
  School bag in hand, 
  She leaves home in the ear -- ly mor -- ning, 
  Wa -- ving good -- bye with an ab -- sent mind -- ed smile. 
  I watch her go with a surge of that well -- known sad -- ness,
  And I have to sit down for a while. 
  The feel -- ing that I'm los -- ing her for e --  ver,
  And with out real -- ly en -- te -- ring her world, 
  I'm glad when e -- ver I can share her laugh -- ter, 
  That fun -- ny li -- ttle girl. 

  Slip -- ping through my fin -- gers all the time.
  I try to cap -- ture eve -- ry min -- ute, 
  The feel -- ing in it, 
  Slip -- ping through my fin -- gers all the time. 
  Do I real -- ly see what's in her mind? 
  Each time I think I'm close to know -- ing, 
  She keeps on grow -- ing, 
  Slip -- ping through my fin -- gers all the time. 

  Sleep in our eyes, her and me at the break -- fast ta -- ble. 
  Bare -- ly a -- wake, I let pre -- cious time go by. 
  Then when she's gone, there's that odd me -- lan -- cho -- ly feel -- ing,
  And a sense of guilt I can't de -- ny. 
  What hap -- pened to those won -- der -- ful ad -- ven -- tures? 
  The pla -- ces I had planned for us to go. 
  Well, Some of that we did, But most we did -- n't, 

...
sophie_lyr = \lyricmode {
  ...
  When I tell a joke, you've pro -- bab -- ly heard it be -- fore.
  But I have a ta -- lent, a won -- der -- ful thing,
  'Cause ev' -- ry -- one lis -- tens when I start to sing,
  I'm so grate -- ful and proud, 
  All I want is to sing it out loud, 
  So I say, 

  Thank you for the mu -- sic, the songs I'm sing -- ing.
  Thanks for all the joy they're bring -- ing, 
  Who can live with -- out it, I ask in all ho -- nes -- ty,
  What would life be?
  With -- out a song, or a dance, what are we?
  So I say,
  Thank you for the mu -- sic, for gi -- ving it to me.

  Mo -- ther says I was a dan -- cer be -- fore I could walk.
  She says I be -- gan to sing long be -- fore I could talk.
  But I've of -- ten won -- dered, how did it all start,
  Who found out that no -- thing could cap -- ture a heart,
  Like a me -- lo -- dy can?
  Well whom -- ev -- er it was, I'm a fan.
  So I say,
  ...
  I've been so lu -- cky, I am the girl with gol -- den hair.
  I want to sing it out to ev' -- ry -- bo -- dy,
  What a joy! What a life! What a chan -- ce! __

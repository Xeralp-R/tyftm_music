part-Ptwo-one = {
  ...
  \parenthesize r2.\mp \tuplet 3/2 { e'8( gis'8 b'8) } |

  <<
    {
      dis''4~\p \tuplet 3/2 { dis''8 cis''8 dis''8 } b'2~^\markup { \italic "rit." }
      \time 2/4
      b'4\> b'4\fermata\!
    } \\ 
    { 
  ...
  <e' b' e'' >2\arpeggio\arpeggio\arpeggio <<
    {  <e' e'' >4 <e' e'' >4 } \\ {
      bis'2
    }
  >> |
  ...
  r4\mp-leggiero <b' e'' b'' >8 bes''16( <cis'' e'' a'' >16~~~ <cis'' e'' a'' >8) gis''4
  cis''8 |
  % 20
  <<
    \context Voice = "voiceone" {
      \voiceOne
      e''4 dis''4 fis''8( e''8) \oneVoice b''16( gis''16 fis''16 e''16) | \voiceOne
  ...
  >> |
  % 25
  \slashedGrace { cis''8 } gis''8_\markup{\italic "poco a poco cresc."} fis''8 gis''8 cis''8~ cis''2 |
  <<
  ...
  <fis' a' cis'' >4\poco-mf <gis' b' cis'' >4 <e' a' cis'' >8-. r8 r4 |
  % 30
  <a b e' >8-. r8 dis'8 b8 
  <<
    \context Voice = "voiceone" {
  ...
  >>
  r4\poco-mp <e' gis' b' >8-. r8 r4 <fes' g' bes' >8-. r8 |
  << { r4 a'8 b'8~ b'8 b'8 a'8 b8-> } \\ { <cis' e' >4-. r2 } >> |
  % 35
  cis'8-> r8 e'8-> r8 gis'8-> b'4~-- b'16 bis32( cis'32) |
  << { \oneVoice r8 fis'8 cis''8 b'8~ \voiceOne b'8 gis'8 fis'8 e'8-. } \\ { s2 d'2 } >> |
  ...
  <<
    \context Voice = "voiceone" {
      ...
      r8 a'8~ a'4~ a'8 a'4. |
      % 40
      r8 b'8 fis'8 g'8~ g'8 cis''8 g'8 b'8 |
    }
    \context Voice = "voicetwo" {
      \voiceTwo
      cis'2 cis'4 d'8 a8 |
  ...
  <b' e'' b'' >4\ben-mf <b' e'' b'' >8 bes''16( <cis'' e'' a'' >16~~~ <cis'' e''
  a'' >8) gis''4 cis''8 |
  % 50
  <<
    \context Voice = "voiceone" {
  ...
  <<
    \context Voice = "voiceone" {
      ...
      % 55
      gis'8_\markup{\italic "poco a poco cresc."} fis'8 gis'8 cis'8~ cis'2 |
      gis'8 fis'8 gis'8 c'8~ c'2 |
    }
    \context Voice = "voicetwo" {
      \voiceTwo
      bis2 cis'2 |
      % 55
      <a cis' >4.\arpeggio\arpeggio s8 s2 |
      <a c' >4.\arpeggio\arpeggio s8 s2 |
    }
  >>
  ...
  <<
    \context Voice = "voiceone" {
      \voiceOne
      cis''8\rf cis''8 cis''8 c''16 b'16~ b'8 a'8 r4 |
      % 60
  ...
  <a' c'' e'' fis'' >4\f <a' c'' e'' fis'' >4 <a' c'' e'' fis'' >4 <a' c'' e''
  fis'' >4 |
  ...
  >>
   dis'8 b8 cis''4 gis'4 dis'4\fermata |
  \time 4/4
  <b' e'' b'' >8\arpeggio\arpeggio\arpeggio_\markup{\dynamic "f" \italic "leggiero molto" } e''8 <b' e'' b'' >8 bes''16(
  ...
  <<
    ...
    \context Voice = "voicetwo" {
      \voiceTwo
      eis'4 s2. |
      <cis' a' >4 <cis' eis' >4 <cis' fis' >4 s4 |
      r2 <a dis' >2 |
      b'2 b'2 |
      s2 fis''8 cis''8 gis''4 |
      % 85
    }
  >>
  ...
  r2 b8( e'8 gis'8 b'8) |
  % 90
  <gis' b' e'' gis'' >1\arpeggio\arpeggio\arpeggio\arpeggio\fermata |
}
...
part-Ptwo-two = {
  ...
  <<
    { r4 b,8( e8 gis8 b8) r4}\\
    { e,1 | }
  >>
  <bes, g bes >2 << {r4 a4 |} \\ {fis,2 |} >>
  \time 2/4
  ...
  >>
  \time 4/4
  << { r16( gis16 b8~ b4) } \\ {e2 } >> <e bes des' >2 |
  % 5
  <<
    \context Voice = "voiceone" {
      \voiceOne
      \tuplet 3/2 { r8 cis8 fis8 }
      \tuplet 3/2 { a8 \change Staff = "upper" cis'8 e'8 }
      \change Staff = "lower"
      r8 fis8 a4 |
      % 5
  ...
  <<
    \context Voice = "voiceone" {
      \voiceOne
      r8( e8 a8 cis'8~ cis'2) 
      r8 eis8( cis8 gis8 \change Staff = "upper" cis'8 eis'8 gis'4) |
      \change Staff = "lower" 
      r8( cis8 fis4~ fis2) |
      % 10
      fis2 <dis b >2 |
  ...
  <<
    ...
    \context Voice = "voicetwo" {
      ...
      cis,1 |
      % 85
      s4 <eis' gis' >4\arpeggio\arpeggio <e' a' >4
    }
  >> r4 |
  \clef bass
  <b, a >2 r2 |

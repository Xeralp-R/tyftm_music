...
\book {
  ...
  \bookpart {
    ...
    \score {
      \keepWithTag #'(drums a_perc nonchor) \overture
  ...
  \bookpart {
    ...
    \score {
      \keepWithTag #'(drums a_perc nonchor) \dancing_queen
  ...
  \bookpart {
    ...
    \score {
      \keepWithTag #'(drums a_perc nonchor) \waterloo

...
\book {
  ...
  \bookpart {
    ...
    \score {
      \keepWithTag #'(vl_i nonchor) \overture
  ...
  \bookpart {
    ...
    \score {
      \keepWithTag #'(vl_i nonchor) \prelude
  ...
  \bookpart {
    ...
    \score {
      \keepWithTag #'(vl_i nonchor) \dancing_queen
  ...
  \bookpart {
    ...
    \score {
      \keepWithTag #'(vl_i nonchor) \waterloo

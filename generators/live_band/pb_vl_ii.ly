...
\book {
  ...
  \bookpart {
    ...
    \score {
      \keepWithTag #'(vl_ii nonchor) \overture
  ...
  \bookpart {
    ...
    \score {
      \keepWithTag #'(vl_ii nonchor) \prelude
  ...
  \bookpart {
    ...
    \score {
      \keepWithTag #'(vl_ii nonchor) \dancing_queen
  ...
  \bookpart {
    ...
    \score {
      \keepWithTag #'(vl_ii nonchor) \waterloo

...
\book {
  ...
  \bookpart {
    ...
    \score {
      \keepWithTag #'(drum a_perc aperc nonchor) \miiix
  ...
  \bookpart {
    ...
    \score {
      \keepWithTag #'(drum a_perc aperc nonchor) \layl
  ...
  \bookpart {
    ...
    \score {
      \keepWithTag #'(drum a_perc aperc nonchor) \ent
  ...
  \bookpart {
    ...
    \score {
      \keepWithTag #'(drum a_perc aperc nonchor) \sos
  ...
  \bookpart {
    ...
    \score {
      \keepWithTag #'(drum a_perc aperc nonchor) \tcm

...
\book {
  ...
  \bookpart {
    \tocSection bss_tutti \markup { "Bass (Tutti) Part Score" }
    \tocGroup bss_tutti.intro \markup { "Introductory Rite" }
    \tocItem bss_tutti.intro.come \markup { "Come to the Table" }

    \header {
      \come_to_the_table_header
    }
    \score {
      \keepWithTag #'(bass) \keepWithTag #'(tutti) \come_to_the_table
  ...
  \bookpart {
    \tocItem bss_tutti.intro.papal \markup { "Kyrie Eleison, Papal Mass" }
  ...
  \bookpart {
    \tocItem bss_tutti.intro.glory \markup { "Glory to God" }
  ...
  \bookpart {
    \tocGroup bss_tutti.word \markup { "Liturgy of the Word" }
    \tocItem bss_tutti.word.alleluia \markup { "Alleluia (Simplified)" }
  ...
  \bookpart {
    \tocGroup bss_tutti.eucharist \markup { "Liturgy of the Eucharist" }
    \tocItem bss_tutti.eucharist.christify \markup { "Christify" }
  ...
  \bookpart {
    \tocItem bss_tutti.eucharist.holy \markup { "Holy, Holy, Holy" }
  ...
  \bookpart {
    \tocItem bss_tutti.eucharist.when \markup { "When We Eat This Bread" }
  ...
  \bookpart {
    \tocItem bss_tutti.eucharist.amen \markup { "Great Amen, WYD" }
  ...
  \bookpart {
    \tocItem bss_tutti.eucharist.ama_simple \markup { "Ama Namin (Simplified)" }
  ...
  \bookpart {
    \tocItem bss_tutti.eucharist.sapagkat \markup { "Sapagkat sa 'Yo ang Kaharian" }
  ...
  \bookpart {
    \tocItem bss_tutti.eucharist.kordero_cayabyab \markup { "Kordero ng Diyos (Cayabyab)" }
  ...
  \bookpart {
    \tocItem bss_tutti.eucharist.iesu \markup { "Iesu Panis Vitae" }
  ...
  \bookpart {
    \tocGroup bss_tutti.conc \markup { "Concluding Rite" }
    \tocItem bss_tutti.conc.humayot \markup { "Humayo't Ihayag" }

    \header {
      \humayot_ihayag_header
    }
    \score {
      \keepWithTag #'(bass) \keepWithTag #'(tutti) \humayot_ihayag

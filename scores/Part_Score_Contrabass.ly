...
\book {
  ...
  \bookpart {
    \tocItem cbs.eucharist.ama_simple \markup { "Ama Namin (Simplified) (Tacet)" }
  ...
  \bookpart {
    \tocItem cbs.eucharist.sapagkat \markup { "Sapagkat sa 'Yo ang Kaharian (Tacet)" }
  ...
  \bookpart {
    \tocItem cbs.eucharist.kordero_cayabyab \markup { "Kordero ng Diyos (Cayabyab) (doubling bass)" }
  ...
  \bookpart {
    \tocItem cbs.eucharist.iesu \markup { "Iesu Panis Vitae (doubling bass)" }

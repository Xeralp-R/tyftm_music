...
\book {
  ...
  \bookpart {
    \tocItem vln_ii.eucharist.ama_simple \markup { "Ama Namin (Simplified)" }

    \header {
      \ama_namin-simplified_header
    }
    \score {
      \keepWithTag #'(violin_ii) \ama_namin-simplified
  ...
  \bookpart {
    \tocItem vln_ii.eucharist.sapagkat \markup { "Sapagkat sa 'Yo ang Kaharian" }

    \header {
      \sapagkat-simplified_header
    }
    \score {
      \keepWithTag #'(violin_ii) \sapagkat-simplified
  ...
  \bookpart {
    \tocItem vln_ii.eucharist.kordero_cayabyab \markup { "Kordero ng Diyos (Cayabyab)" }
  ...
  \bookpart {
    \tocItem vln_ii.eucharist.iesu \markup { "Iesu Panis Vitae" }

...
\book {
  ...
  \bookpart {
    \tocItem sop_tutti.eucharist.anima \markup { "Anima Christi" }

    \header {
      \anima_christi_header
    }
    \score {
      \keepWithTag #'(soprano) \keepWithTag #'(tutti) \anima_christi
  ...
  \bookpart {
    ...
    \score {
      \keepWithTag #'(soprano) \keepWithTag #'(tutti) \iesu_panis_vitae_verse_one
    }
    \score {
      \keepWithTag #'(soprano) \keepWithTag #'(tutti) \iesu_panis_vitae_verse_two
    }
    \score {
      \keepWithTag #'(soprano) \keepWithTag #'(tutti) \iesu_panis_vitae_verse_three
    }
    \score {
      \keepWithTag #'(soprano) \keepWithTag #'(tutti) \iesu_panis_vitae_verse_four
    }
    \score {
      \keepWithTag #'(soprano) \keepWithTag #'(tutti) \iesu_panis_vitae_verse_five
    }
    \score {
      \keepWithTag #'(soprano) \keepWithTag #'(tutti) \iesu_panis_vitae_verse_six
    }
    \score {

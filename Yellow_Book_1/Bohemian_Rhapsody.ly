...
right = {
  ...
  \relative c' {
    ...
    <b fis' b>8 q <bes f' bes>4 <a e' a>8 q <bes f' bes>4 |
    <<
      \new Voice = "ra12" \relative c'' {
        \voiceOne
        g8 g g g f4 bes4 | \newpage
        e,8 e e e <a, f'>4 f8 a |
      }
      \new Voice = "rb12" \relative c' {
        \voiceTwo
        <bes ees?>2 <bes f'>2 |
        bes2 s2 |
      }
    ...
    % 15
    <<
      \new Voice = "ra15" \relative c' {
        \voiceOne
        r8 f( bes d <g g,>4 <f f,>4) |
      }
      \new Voice = "rb15" \relative c' {
        \voiceTwo
        bes2. r4
      }
    >>
    ...
    \repeat volta 2 {
      ...
      d8 d~ d2 d8 f |
      <<
        \new Voice = "ra23" \relative c'' {
          \voiceOne
          a8 g8 g2 r8 g8 | \newline
          bes8 bes bes bes bes g ees d |
        }
        \new Voice = "rb23" \relative c' {
          \voiceTwo
          <d bes>2. r4 |
          ees2 ees4 g,4 |
        }
      ...
      % 25
      <<
        \new Voice = "ra25" \relative c'' {
          \voiceOne
          g8 g~ g2 f8 g16 aes |
        }
        \new Voice = "rb25" \relative c' {
          \voiceTwo
          <ees bes>2. bes4 |
        }
      >> \newpage
      ...
      <<
        \new Voice = "ra27" \relative c'' {
          \voiceOne
          <aes f>8 g g f f4. bes8
        }
        \new Voice = "rb27" \relative c' {
          \voiceTwo
          c2 c4. r8
        }
      >>
    ...
    <<
      \new Voice = "ra62" \relative c'' {
        \voiceOne
        c8( ees bes ees a, ees' aes, ees') |
      }
      \new Voice = "rb62" \relative c' {
        \voiceTwo
        ees2 ees2 |
      }
    >> \newpage
    ...
    <d f! bes>2. <bes d g>4 |
    <<
      \new Voice = "ra81" \relative c'' {
        \voiceOne
        c2 bes4 g |
      }
      \new Voice = "rb81" \relative c' {
        \voiceTwo
        <d f>2. <bes d>4 |
      }
    >> \newline
    ...
    <<
      \new Voice = "ra98" \relative c''' {
        \voiceOne
        g4 f2( g4) |
      }
      \new Voice = "rb98" \relative c'' {
        \voiceTwo
        <bes d>1 |
      }
    >>
    ...
    <<
      \new Voice = "ra109" \relative c'' {
        \voiceOne
        c4. c16 d bes2 |
      }
      \new Voice = "rb109" \relative c' {
        \voiceTwo
    ...
    <<
      \new Voice = "ra112" \relative c'' {
        \voiceOne
        <ees g>8 f f ees ees c?4 d8 |
      }
      \new Voice = "rb112" \relative c'' {
        \voiceTwo
...
left = {
  ...
  \relative c {
    ...
    bes2. d,4 |
    <<
      \new Voice = "la6" \relative c {
        \voiceOne
        r4 bes( g' bes,) |
      }
      \new Voice = "lb6" \relative c, {
        \voiceTwo
        e1 |
      }
    >>
...
Bohemian_Rhapsody = \bookpart {
  \tocItem \markup "Mercury. Bohemian Rhapsody"
  \header {

...
left = {
    ...
    % 10
        e,8_( b, <e g>4) e,16_( b, e fis g4) |
        e,8_( e <gis b d'>4) a,16^( e a b c'4) |
        a,16^( e a b c'4) e,16_( b, e fis g4) |
    ...
    % 25
        ...
        as,8_( des <f as>4) as,16^( des f as c'4) |
    % 40
        es,8_( bes, <es g>4) es8^( bes <des' g>4) |
